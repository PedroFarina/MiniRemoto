...
public class DataController {
    ...
    public func createUser() {
        ...
        self.user = user
//        EndpointsRequests.Requests.postRequest(url: "\(DataController.hostaddress)/createUser", params: ["id":id], decodableType: Response.self) { (answer) in
//            switch answer {
...
//        }
    ...
    public func createEvent(name: String, color: AppColor, startDate: String?, startHour: String?, endHour: String?, items: [Item]?, location: Location?, invitees: [Invitee]?) {
        ...
        self.notifyObservers()
//        print(String(bytes: try! JSONEncoder().encode(event), encoding: .utf8)!)
